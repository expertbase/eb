...
var JQVMap = function (params) {
  ...
  $(params.container).on(this.canvas.mode === 'svg' ? 'path' : 'shape', 'mouseover mouseout', function (e) {
  ...
  $(params.container).on(this.canvas.mode === 'svg' ? 'path' : 'shape', 'click', function (regionClickEvent) {
