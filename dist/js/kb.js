 ...
 **************************************************************** **/
	function _topNav() {
		...
		$("#topMain a.dropdown-toggle").on("click", function(e) {
		...
		// Page Menu [mobile]
		$("button#page-menu-mobile").on("click", function() {
		...
		// Page Menu [scrollTo]
		$("#page-menu ul.menu-scrollTo>li").on("click", function(e) {
			...
			if(!$('a', this).hasClass('external')) {
				...
				$("#page-menu ul.menu-scrollTo>li").removeClass('active');
				...
				if($(_href).length > 0) {
					...
					if($("#header").hasClass('sticky')) {
						_padding_top = $(_href).css('padding-top');
						_padding_top = _padding_top.replace('px', '');
					}

					$('html,body').animate({scrollTop: $(_href).offset().top - _padding_top}, 800, 'easeInOutExpo');
		...
		// Right Panel
		$("#sidepanel_btn").on("click", function(e) {


			if($("#sidepanel").is(":hidden")) {

				$("body").append('<span id="sidepanel_overlay"></span>').addClass("stopscroll");
			...
			$("#sidepanel_overlay").off();
			$("#sidepanel_overlay").on("click", function() {
				$("#sidepanel_btn").trigger('click');
			});

		});
		// button close
		$("#sidepanel_close").on("click", function(e) {
			e.preventDefault();
			$("#sidepanel_btn").trigger('click');
		});
		...
		// Left Panel
		$("a#panel_left_btn").on("click", function(e) {
			e.preventDefault();


			if($("#panel_left").is(":hidden")) {

				$("body").append('<span id="panel_left_overlay"></span>');
				$("#panel_left").stop().show().animate({"left":"0"}, 300);

			} else {

				$("#panel_left_overlay").remove();
				$("#panel_left").stop().animate({"left":"-300px"}, 300);
			...
			$("#panel_left_overlay").off();
			$("#panel_left_overlay").on("click", function() {
				$("a#panel_left_btn").trigger('click');
				});

		});
		// button close
		$("#panel_left_close").on("click", function(e) {
			e.preventDefault();
			$("a#panel_left_btn").trigger('click');
		});
...
$(document).ready(function($) {
    $(".scrll").on("click",function(event){     
        ...
        $('html,body').animate({scrollTop:$(this.hash).offset().top-50}, 1900, "swing");
    });
// prevent some crap with chrome        
$(".set").show();



$(".is").hide();
$('.bling').on("click",function() { 	
	$(this).toggleClass("Demo alter");
	$("i", this).toggleClass("angle-down angle-up");
	$(this).find('.is').slideToggle('slow');
});
$(".all").on("click",function(){ 
	$(".all").hide();
	$("i").removeClass("angle-down").addClass("angle-up");
	$(".la").removeClass("la").addClass("lu");
	$('.is').slideDown('slow');
});
});
...
$('#open_hm').on("click",function() {
	$(this).hide('slow');
	$('#hm_show').slideDown('slow');
});
